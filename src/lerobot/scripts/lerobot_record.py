...
def record_loop(
    ...
    events: dict,
    fps: int,
    teleop_action_processor: RobotProcessorPipeline,  # runs after teleop
    robot_action_processor: RobotProcessorPipeline,  # runs before robot
    robot_observation_processor: RobotProcessorPipeline,  # runs after robot
