...
# 处理器注册名全部替换 vla_jepa → smolvla_lew
@ProcessorStepRegistry.register(name="smolvla_lew_clip_actions")
...
@ProcessorStepRegistry.register(name="smolvla_lew_pre_snap_gripper")
...
@ProcessorStepRegistry.register(name="smolvla_lew_binarize_gripper")
...
# 工厂函数重命名、入参Config同步替换
def make_smolvla_lew_pre_post_processors(
