...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "zmax_hybrid":
        return ZmaxHybridConfig(**kwargs)
    else:
        try:
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ZmaxHybridConfig):
        from .zmax_hybrid.processor_zmax_hybrid import make_zmax_hybrid_pre_post_processors

        processors = make_zmax_hybrid_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
