...
画布三级能力 (2026-09-08 定稿) → 本文件权威数据源:
  L2 🔧 基础辅助功能   = 分段式小模型 + 原子技能 (YOLO+前馈MLP+13段状态机+安全限幅)
  L3 🚀 高级自动功能   = 端到端 VLM(通用视觉) + Flow-Matching DiT ActionHead
  L4 🏆 专家自主功能   = 世界模型 (潜空间预测/流形导航/标定/自主恢复/肌肉记忆)
