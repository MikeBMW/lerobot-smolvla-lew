...
NODE_TREE = {
    ...
    "ssff": {
        ...
        "funcs": [
            {"fid": "FNff01", "name": "比例引导驱动", "desc": "蒸馏 MLP 比例引导 (547K 前向学解析教师 Kp·Δ, 训练域内近似; 解析律降级为域外守卫 D_GUARD=0.25)",
             "tests": [
                 ("指向目标方向", "auto", "t_F_B02", ""),
            ...
            {"fid": "FNff02", "name": "近距收敛闭合", "desc": "接近目标时闭合控制 (近距判据 d_xy<0.03)",
             "tests": [
            ...
            {"fid": "FNff03", "name": "输出幅值限幅", "desc": "前馈输出 ±0.6 限幅 (反归一化后 clip; 旧解析律 ±0.5 随主路径退役)",
             "tests": [
    ...
    "ssmani_p": {
        ...
        "funcs": [
            {"fid": "FNmp01", "name": "对准代价评估", "desc": "光模块头−孔底 加权二次代价",
             "tests": [
                 ("代价计算正确", "auto", "t_mp_v", ""),
                 ("横向重权", "auto", "t_mp_w", ""),
