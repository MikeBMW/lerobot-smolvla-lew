...
for t in range(max_frames):
    ...
    out.append(frame)
h, w = out[0].shape[:2]
writer = cv2.VideoWriter('/home/xspace/lerobot-smolvla-lew/reports/compare_7model_container.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 10, (w, h))
