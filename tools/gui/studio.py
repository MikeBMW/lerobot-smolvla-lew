...
class SystemSidebar(QFrame):
    ...
    def _build(self):
        ...
        ver = QLabel("Z-MAX v5.5.52")  # 品牌版本小字 (菜单栏右侧有同款, 此处紧凑显示)
...
class StudioMainWindow(QMainWindow):
    def _maybe_warn(self):
        ...
        if not _ok:
            try:
                self.setWindowTitle("XSpace Studio — Z-MAX v5.5.52 [W-01] ⚠️非调试模式")
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("XSpace Studio — Z-MAX v5.5.52 [W-01]")
