...
REFERENCE_APPS = [
    ...
    ("🎛 CICD 主控台", [
        ("hardware", "📥 Orin 数据源", {"ip": "192.168.23.10", "fps": 30, "source": "orin",
                                        "desc": "真实产线数据"}),
        ("hardware", "📦 metaworld 数据", {"steps": 100, "source": "metaworld",
                                           "desc": "占位集·管道验证"}),
        ("switch", "🔀 Switch 数据源", {"switch": "orin", "desc": "双击切换 Orin/metaworld"}),
        ("model", "🧠 ACT 训练", {"steps": 100, "chunk_size": 7, "dim_model": 256,
    ...
    ("🧠 ACT-Meta 全新训练", [
        ...
        ("system", "🚀 全新训练", {"steps": 100, "desc": "双击 → on_train (metaworld 占位集, 全新不续训)"}),
    ...
    ("🔬 三模型对比", [
        ...
        ("system", "🚀 ACT 训练", {"policy": "act", "steps": 100,
        ...
        ("system", "🚀 SmolVLA 训练", {"policy": "smolvla", "steps": 100,
        ...
        ("system", "🚀 SmolVLA+LEW 训练", {"policy": "smolvla_lew", "steps": 100,
