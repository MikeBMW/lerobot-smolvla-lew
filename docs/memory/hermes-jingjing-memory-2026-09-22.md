...
§
真机视: 产线相机节点不自启→须手动只起camera/realsense_source(参数1:1抄launch, 别起整条launch); tap→cam_rs.png(YOLO读文件); cam_local.png=本机兜底且永不抢源; 拔出=L2.pull_module(退15mm钩环→合爪f30→退120mm)