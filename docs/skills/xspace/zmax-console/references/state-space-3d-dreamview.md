...
- 插销 peg: 金色 box (0.07,0.05,0.05) 随末端

## 坑
1. **插销/插座俯视遮挡**: 插座 box 高度曾 0.06 盖住插销(z=0.048) → 插座压矮到 z<0.03, 插销露在插座上方
...
## 验证
- 渲染验证: 截图数像素颜色 (金色插销 r>200&g140-230&b<90, 红插座 r>200&g30-90&b<70, 橙机械臂 r>120&g40-130&b<80)
